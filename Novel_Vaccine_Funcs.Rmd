...
```{r, echo=FALSE}
plot(SumOfVaccinated, topnov, type = "o", col = "red",lwd=2, ylim = 0:1, xlab="Number of V+", ylab = "Vaccination Probability")#A+
...
Probability of attitude transition if 
...
#
neut_conf_trans2 = 0.003125*SumOfPostitives^2 - 0.0875*SumOfPostitives + 0.8
