...
#Increase prob of change
yy = kk + (1-kk)*x^n

yy = kk + (1-kk)*x #should work

#decrease prob of change

yy = x- (kk*x) #Probably better to not have n (not mutually scalable)

yy = x*(1-kk^n) #need to adjust n (n = 5 too close to y=x)

yy = x*(1-exp(-n*kk)) #need to adjust n (y too small)
